...
function addBuff(_0x139bc4, _0x2a12d3, _0x41fa97) {
  ...
  for (const _0xff73c0 of _0x3807a8) {
    ...
    if (_0xff73c0.type == "힐") {
      ...
      let _0x3f0e59;
      if (_0x2a12d3.includes("평")) {
        _0x3f0e59 = "평" + _0x41fa97 + _0xff73c0.type;
      } else if (_0x2a12d3.includes("궁")) {
        _0x3f0e59 = "궁" + _0x41fa97 + _0xff73c0.type;
      } else if (_0x2a12d3.includes("방")) {
        _0x3f0e59 = "방" + _0x41fa97 + _0xff73c0.type;
      } else if (_0x2a12d3.includes("피격")) {
        _0x3f0e59 = "피격" + _0x41fa97 + _0xff73c0.type;
      } else if (_0x2a12d3.includes("공격")) {
        _0x3f0e59 = "공격" + _0x41fa97 + _0xff73c0.type;
      } else if (_0x2a12d3.includes("행동")) {
        _0x3f0e59 = "행동" + _0x41fa97 + _0xff73c0.type;
      }
      const _0x240b68 = actionMap.get(_0x3f0e59);
      if (_0x240b68) {
...
function getBuffSizeList(_0x1a6d3d) {
  ...
  for (const _0x59757c of _0x425688) {
    ...
    if (buff_ex.includes(_0x59757c.type)) {
      continue;
    }
...
function getBossBuffSizeList(_0x3d744a) {
  ...
  for (const _0x177700 of _0x4a37de) {
    ...
    if (buff_ex.includes(_0x177700.type)) {
      continue;
    }
...
function tbf() {
  const _0x1b0875 = Array.from(arguments);
  if (_0x1b0875.length != 5) {
    showAlert(_0x1b0875);
  }
  buff(..._0x1b0875, true);
}
function ptbf() {
  const _0x2a6343 = Array.from(arguments);
  if (_0x2a6343.length != 8) {
    showAlert(_0x2a6343);
  }
  buff(..._0x2a6343, "추가", true);
}
function atbf() {
  const _0xe7951b = Array.from(arguments);
  if (_0xe7951b.length != 8) {
    showAlert(_0xe7951b);
  }
  buff(..._0xe7951b, "발동", true);
}
function nbf() {
  const _0x38d25b = Array.from(arguments);
  if (_0x38d25b.length != 6) {
    showAlert(_0x38d25b);
  }
  buff(..._0x38d25b, true);
}
function pnbf() {
  const _0x3cebc1 = Array.from(arguments);
  if (_0x3cebc1.length != 9) {
    showAlert(_0x3cebc1);
  }
  buff(..._0x3cebc1, "추가", true);
}
function anbf() {
  const _0x25387a = Array.from(arguments);
  if (_0x25387a.length != 9) {
    showAlert(_0x25387a);
  }
  buff(..._0x25387a, "발동", true);
}
