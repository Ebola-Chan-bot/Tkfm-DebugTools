...
function setAsc(me, list) {
   me.cd = list[1]; me.curCd = list[1]; me.ultmag = list[0];
}
/* -------------------------------------------------------------------------------------- */
function setDefault(me, asc) {let aa; switch(me.id) {
   case 10001 : // 바알 ok
   ...
   case 10008 : // 섹돌 ok
      ...
      return me;
   case 10017 : // 페바알 ok
      aa = [[165, 4], [188, 4], [211, 4], [211, 4], [211, 3]];
      setAsc(me, aa[asc-1]);
      me.ultbefore = function() {
         // 궁극기 : 태양제의 성찬
         // 1구 : 자신의 공격 데미지 25% 증가(3턴), 공격 데미지의 165%만큼 적 전체에게 데미지 [CD:4]
         if (asc == 1) tbf(me, "공퍼증", 25, "태양제의 성찬", 3);
         // 2구 : 자신의 공격 데미지 25% 증가 (3턴), 공격 데미지의 188%만큼 적 전체에게 데미지 [CD:4]
         // 3구 : 자신의 공격 데미지 25% 증가 (3턴), 공격 데미지의 211%만큼 적 전체에게 데미지 [CD:4]
         // 4구 : 자신의 공격 데미지 35% 증가 (3턴), 공격 데미지의 211%만큼 적 전체에게 데미지 [CD:4]
         // 5구 : 자신의 공격 데미지 35% 증가 (4턴), 공격 데미지의 211%만큼 적 전체에게 데미지 [CD:3]
         if (asc == 5) tbf(me, "공퍼증", 35, "태양제의 성찬", 4);
      }
      me.ultafter = function() {}
      me.ultimate = function() {ultLogic(me);};
      me.atkbefore = function() {}
   ...
   case 10018 : // 울타 ok
      ...
      me.ultbefore = function() {
         // 궁극기 : 용자 돌진 - 엉망진창
         if (asc == 1) {
            // 1구 : 자신에게 최대 HP의 30%만큼 아머 강화 + 도발 효과 + 받는 데미지 20% 감소(1턴)
            tbf(me, "아머", me.hp*30*armorUp(me, "궁", "추가"), "용자 돌진 - 엉망진창1", 1);
            // 1구 : 자신이 공격 시 "기본 공격 데미지의 150%만큼 타깃에게 데미지" 효과 추가 (3턴) [CD : 3]
            tbf(me, "평추가+", me.atk*150, "용자 돌진 - 엉망진창2", 3);
            tbf(me, "궁추가+", me.atk*150, "용자 돌진 - 엉망진창3", 3);
         }
         // 2구 : 자신에게 최대 HP의 35%만큼 아머 강화 + 도발 효과 + 받는 데미지 20% 감소(1턴)
         // 2구 : 자신이 공격 시 "기본 공격 데미지의 190%만큼 타깃에게 데미지" 효과 추가 (3턴) [CD : 3]
         // 3구 : 자신에게 최대 HP의 40%만큼 아머 강화 + 도발 효과 + 받는 데미지 25% 감소(1턴)
         // 3구 : 자신이 공격 시 "기본 공격 데미지의 190%만큼 타깃에게 데미지" 효과 추가 (3턴) [CD : 3]
         // 4구 : 
         if (asc == 5) {
            // 5구 : 자신에게 최대 HP의 50%만큼 아머 강화 + 도발 효과 + 받는 데미지 30% 감소(1턴)
            tbf(me, "아머", me.hp*50*armorUp(me, "궁", "추가"), "용자 돌진 - 엉망진창1", 1);
            // 5구 : 자신이 공격 시 "기본 공격 데미지의 230%만큼 타깃에게 데미지" 효과 추가 (4턴)
      ...
      return me;
   case 10019 : // 아야네 ok
      aa = [[330, 4], [376, 4], [422, 4], [468, 4], [514, 4]];
      setAsc(me, aa[asc-1]);
      me.ultbefore = function() {
         // 궁극기 : 성검해방 - 성신역법
         // 1구 : 자신의 공격 데미지 30% 증가(3턴), 자신의 공격 데미지 330%만큼 타깃에게 데미지 [CD : 4]
         if (asc == 1) tbf(me, "공퍼증", 30, "성검해방 - 성신역법", 3);
         // 2구 : 자신의 공격 데미지 30% 증가(3턴), 자신의 공격 데미지 376%만큼 타깃에게 데미지 [CD : 4]
         // 3구 : 자신의 공격 데미지 35% 증가(3턴), 자신의 공격 데미지 422%만큼 타깃에게 데미지 [CD : 4]
         // 4구 : 자신의 공격 데미지 40% 증가(3턴), 자신의 공격 데미지 468%만큼 타깃에게 데미지 [CD : 4]
         // 5구 : 자신의 공격 데미지 45% 증가(3턴), 자신의 공격 데미지 514%만큼 타깃에게 데미지 [CD : 4]
         if (asc == 5) tbf(me, "공퍼증", 45, "성검해방 - 성신역법", 3);
      }
      me.ultafter = function() {}
      me.ultimate = function() {ultLogic(me);};
      me.atkbefore = function() {}
      ...
      return me;
   case 10020 : // 무엘라 ok
      aa = [[265, 3], [298, 3], [331, 3], [364, 3], [397, 3]];
      setAsc(me, aa[asc-1]);
      me.ultbefore = function() {}
      me.ultafter = function() {
         // 궁극기 : 일렉트로 마그네틱 펄스
         // 1구 : 자신의 공격 데미지의 265%만큼 타깃에게 데미지, 적 전체가 가하는 데미지 5% 감소(최대 3중첩) [CD : 3]
         // 2구 : 자신의 공격 데미지의 298%만큼 타깃에게 데미지, 적 전체가 가하는 데미지 5% 감소(최대 3중첩) [CD : 3]
         // 3구 : 자신의 공격 데미지의 331%만큼 타깃에게 데미지, 적 전체가 가하는 데미지 7.5% 감소(최대 2중첩) [CD : 3]
         // 4구 : 자신의 공격 데미지의 364%만큼 타깃에게 데미지, 적 전체가 가하는 데미지 7.5% 감소(최대 2중첩) [CD : 3]
         // 5구 : 자신의 공격 데미지의 397%만큼 타깃에게 데미지, 적 전체가 가하는 데미지 15% 감소(최대 1중첩) [CD : 3]
      }
      me.ultimate = function() {ultLogic(me);};
      me.atkbefore = function() {}
      me.atkafter = function() {}
      ...
      return me;
   case 10021 : // 하쿠 ok
      aa = [[0, 4], [0, 4], [0, 4], [0, 4], [0, 4]];
      setAsc(me, aa[asc-1]);
      me.ultbefore = function() { // 궁극기 : 재생의 바람
         if (asc == 1) {
            // 1구 : 공격 데미지의 50%만큼 아군 전체를 치유
            // 1구 : 자신의 공격 데미지의 60%만큼 매턴 아군 전체를 치유(4턴)
            for(let i = 0; i < 4; i++) me.healTurn.push(GLOBAL_TURN+i);
            // 1구 : 자신 이외의 동료들의 공격 데미지 15% 증가(4턴) [CD : 4]
            for(let c of comp) if (c.id != me.id) tbf(c, "공퍼증", 25, "재생의 바람1", 4);
         }
         // 2구 : 공격 데미지의 50%만큼 아군 전체를 치유, 자신의 공격 데미지의 70%만큼 매턴 아군 전체를 치유(4턴), 자신 이외의 동료들의 공격 데미지 17.5% 증가(4턴) [CD : 4]
         // 3구 : 공격 데미지의 50%만큼 아군 전체를 치유, 자신의 공격 데미지의 80%만큼 매턴 아군 전체를 치유(4턴), 자신 이외의 동료들의 공격 데미지 17.5% 증가(1턴), 자신 이외의 동료들의 공격 데미지 17.5% 증가(4턴) [CD : 4]
         // 4구 : 공격 데미지의 50%만큼 아군 전체를 치유, 자신의 공격 데미지의 90%만큼 매턴 아군 전체를 치유(4턴), 자신 이외의 동료들의 공격 데미지 20% 증가(1턴), 자신 이외의 동료들의 공격 데미지 20% 증가(4턴) [CD : 4]
         // 5구 : 공격 데미지의 50%만큼 아군 전체를 치유, 자신의 공격 데미지의 100%만큼 매턴 아군 전체를 치유(4턴), 자신 이외의 동료들의 공격 데미지 25% 증가(1턴), 자신 이외의 동료들의 공격 데미지 25% 증가(4턴) [CD : 4]
         if (asc == 5) {
            // 5구 : 공격 데미지의 50%만큼 아군 전체를 치유
            // 5구 : 자신의 공격 데미지의 100%만큼 매턴 아군 전체를 치유(4턴)
            for(let i = 0; i < 4; i++) me.healTurn.push(GLOBAL_TURN+i);
            // 5구 : 자신 이외의 동료들의 공격 데미지 25% 증가(1턴)
            for(let c of comp) if (c.id != me.id) tbf(c, "공퍼증", 25, "재생의 바람1", 1);
            // 5구 : 자신 이외의 동료들의 공격 데미지 25% 증가(4턴)
            for(let c of comp) if (c.id != me.id) tbf(c, "공퍼증", 25, "재생의 바람1", 4);
         }
      }
      me.ultafter = function() {}
